...
wp_df <- data.frame(
  ...
  task = c("Create questionaire for contributers and interested parties", 
           ...
           "Create dataset of related literature",
           "Perform literature review", 
           "Write taxon-focused literature review",
           "photos", "occurrence data", "data management plan", "data quality",
           "analyses and version control",
...
## Task 1.3 List of expected and possible outcomes
...
## Task 2.1: Search for relevant sources
...
- source categories: `empirical`, `review`, `theoretical`, `methodological`, `applied`, `historical`, `species_checklist`, `unpublished`, `online`
...
## Task 2.5: Write comprehensive literature review
...
## Task 2.6: Write literature report

Finally, we create a concise but complete literature report for publication. It is a summary of the previous task and contains graphs (e.g. for visualizing trends in literature topics and frequencies) and tables [cf. @groh2012bibliography].
